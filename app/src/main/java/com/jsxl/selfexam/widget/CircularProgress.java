...
public class CircularProgress extends View {
    ...
    private static final int DEFAULT_BORDER_WIDTH = 4;//改变线的粗细
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.colorStatus);
        mColors[1] = context.getResources().getColor(R.color.colorStatus);
        mColors[2] = context.getResources().getColor(R.color.colorStatus);
        mColors[3] = context.getResources().getColor(R.color.colorStatus);

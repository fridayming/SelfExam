...
import com.jsxl.selfexam.widget.DatePickerView;
...
//                handler.handle(sdf.format(selectedCalender.getTime()));
                ...
                handler.handle(Integer.parseInt(sdf.format(new Date()))-Integer.parseInt(sdf.format(selectedCalender.getTime()))+"");
                datePickerDialog.dismiss();
            }
        });
    }

...
import static com.jsxl.selfexam.R.id.cb_collect;
import static com.jsxl.selfexam.R.id.rb_answer4;
import static com.jsxl.selfexam.R.id.tv_solution;
import static com.jsxl.selfexam.R.id.vp_container;

/**
 * A simple {@link Fragment} subclass.
 */
public class QuestionClozeTestFragment extends Fragment implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    private View view;
    private QuestionEntity.Question4sBean question;
    ...
    public QuestionClozeTestFragment(){}
    @SuppressLint({"NewApi", "ValidFragment"})
    public QuestionClozeTestFragment(QuestionEntity.Question4sBean question, QuestionNextOrLastClickListener listener, AnswerJudgeListener answerJudgeListener, int currentItem, int total, boolean isTest, int chapterId, String answer) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_question_cloze_test, container, false);

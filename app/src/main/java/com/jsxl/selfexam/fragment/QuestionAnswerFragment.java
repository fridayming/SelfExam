...
public class QuestionAnswerFragment extends Fragment implements View.OnClickListener {
    private QuestionEntity.Question3sBean question;
    private View view;
    ...
    @SuppressLint({"NewApi", "ValidFragment"})
    public QuestionAnswerFragment(QuestionEntity.Question3sBean question, QuestionNextOrLastClickListener listener, AnswerJudgeListener answerJudgeListener, int currentItem, int total, int chapterId, String answer) {
    ...
    private void initData() {
        ...
        //对edittext进行监听 如果有文字改变则通知activity
